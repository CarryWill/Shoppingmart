...
<div  style="height:100%;">
  <ul id="navigation">
    <li> <a class="head">商品管理</a>
      <ul>
        <li><a href="${pageContext.request.contextPath}/CategoryServlet?op=addProduct" target="rightFrame">添加商品</a></li>
    ...
    <li> <a class="head">注册用户管理</a>
      <ul>
        ...
        <li><a href="${pageContext.request.contextPath }/user/UserServlet?op=findAllUser&num=1" target="rightFrame">查看普通注册用户</a></li>
      </ul>
    </li>
