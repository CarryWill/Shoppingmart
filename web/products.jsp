...
<title>Cats Store - Products</title>
<meta name="keywords" content="cats store, products, free template, ecommerce, online shopping, website templates, CSS, HTML" />
<meta name="description" content="Cats Store, Products, free shopping template provided " />
...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
    	<div id="site_title"><h1><a href="http://localhost/${pageContext.request.contextPath }">Online Cats Store</a></h1></div>
        <div id="header_right">
        	<p>
                    	...
                    	<c:forEach items="${categories }" var="category" varStatus="vs">
                			<c:if test="${vs.index !=0}">
                				<c:if test="${vs.index != fn:length(categories)-1 }">
                					<li>
                						<a href="${pageContext.request.contextPath }/admin/ProductServlet?op=findProductsbyCid&cid=${category.cid}">${category.cname}</a>
                					</li>
                				</c:if>
                			</c:if>
                			<c:if test="${vs.index==0 }">
        ...
        <div id="content" class="float_r">
        	...
        	<c:forEach items="${requestScope.products }" var="product" varStatus="vs">
        		<div class="${vs.index % 3 != 2?'product_box':'product_box no_margin_right' }">
	            	<a href="${pageContext.request.contextPath }/admin/ProductServlet?op=findProductByPId&pid=${product.pid}">
	                ...
	                <a href="${pageContext.request.contextPath }/admin/ProductServlet?op=findProductByPId&pid=${product.pid}" class="detail"></a>
            	</div>
